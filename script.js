const questions = [
    ...
    { word: "homemade", correct: "домашнього приготування", options: ["магазинний", "фабричний", "домашній"] },
    ...
    { word: "chew up", correct: "жувати", options: ["кусати", "ковтати", "жувати, гризти"] },
    ...
    { word: "health and safety", correct: "охорона праці та безпека", options: ["закони", "здоров'я та безпека", "фінанси"] },
    { word: "over the speed limit", correct: "перевищення швидкості", options: [" поза лімітом швидкості", "аварія", "ремонт"] },
