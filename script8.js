const questions = [
    ...
    { word: "go on to", correct: "перейти до чогось (у майбутньому)", options: ["перейти до чогось (у майбутньому)", "здатися", "зупинитися"] },
    ...
    { word: "settle down", correct: "осісти / заспокоїтись", options: ["осісти / заспокоїтись", "поїхати", "злитися"] },
